...
function MyApp({ Component, pageProps, router }: AppProps) {
  return <ThemeProvider attribute="class">
    <div className="grid grid-cols-12 gap-6 px-5 py-14 lg:mb-0 md:mb-16 sm:px-15 md:px-20 lg:px-24 xl:px-30 2xl:px-36">
      ...
      <div className="flex flex-col col-span-12 bg-white shadow-custom-light dark:shadow-custom-dark rounded-2xl lg:col-span-9 dark:bg-dark-500 dark:border-t-2 dark:border-gray-600">
        <Navbar />
