...
export const projects: IProject[] = [
    ...
    {
        id: 16,
        name: "Single Page Store With Cart",
        image_path: "https://i.ibb.co/wK1Kpfq/screencapture-sohagstore-netlify-app-2022-08-06-17-00-15.png",
        deployed_url: "https://sohagstore.netlify.app/",
        github_url: "https://github.com/sohagraha/One-Page-Store-with-Cart",
        category: ["HTML", "CSS", "JavaScript"],
        description:
            "Single page Store with dynamic cart. When any user add to cart an item the cart price automatically update and show the total amount on the right part",
        key_techs: ["HTML", "CSS", "JavaScript"],
        status: "complete",
    },
    {
        id: 17,
        name: "Book Finder",
        image_path: "https://i.ibb.co/K79217D/Capture.jpg",
        deployed_url: "https://bookarchiver.netlify.app/",
        github_url: "https://github.com/sohagraha/Find-Your-Book",
        category: ["HTML", "CSS", "JavaScript"],
        description:
            "Book Finder. User can search here by book name. At the top we see that the number of total showed book and found books. User also see the book details upto 100 from the founded item",
        key_techs: ["HTML", "CSS", "JavaScript"],
        status: "complete",
    },
    {
        ...
        image_path: "https://i.ibb.co/P9Y51Cf/Capturezx.jpg",
        deployed_url: "https://sohagraha.github.io/covid-live-update/",
        github_url: "https://github.com/sohagraha/covid-live-update",
        category: ["HTML", "CSS", "JavaScript"],
        description:
            "Covid Live Update. This site is update the total number of covid cases in the world. This site is also update the total number of covid cases in the country. This site is also update the total number of covid cases in the state.",
    ...
    },
    {
        ...
        image_path: "https://i.ibb.co/ryM588r/screencapture-sohagraha-github-io-weather-report-2022-08-06-17-33-42.png",
        deployed_url: "https://sohagraha.github.io/weather_report/",
        github_url: "https://github.com/sohagraha/weather_report",
        category: ["HTML", "CSS", "JavaScript"],
        description:
            "Weather Report. This site is update the weather report of the country. By provide city name we get the weather condition of that city and temperature also.",
        key_techs: ["HTML", "CSS", "JavaScript", "Bootstrap"],
        status: "complete",
    },
    {
        id: 19,
        name: "Pin Generator",
        image_path: "https://i.ibb.co/HFVGVmK/Capturezxw.jpg",
        deployed_url: "https://pin-generators.netlify.app/",
        github_url: "https://github.com/sohagraha/pin-generator",
        category: ["HTML", "CSS", "JavaScript"],
        description:
            "Generate Random Pin. This site is generate random pin number. User can generate any number of pin number and try to input the pin number by click on number button, every time user get 3 times to input the correct pin number. If anybody write wrong pin number then the remain times will decrease by 1. Every time user get a alert message on the bottom part.",
        key_techs: ["HTML", "CSS", "JavaScript", "Bootstrap"],
        status: "complete",
    },
];